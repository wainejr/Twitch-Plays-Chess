...
def script_properties():
    ...
    obs.obs_properties_add_int(
        props, "number_voters", "Number of voters", 10, 50, 1)

    p1 = obs.obs_properties_add_list(props, "source_users", "Users source", 
        obs.OBS_COMBO_TYPE_EDITABLE, obs.OBS_COMBO_FORMAT_STRING)
    p2 = obs.obs_properties_add_list(props, "source_n_votes", "Votes source", 
        obs.OBS_COMBO_TYPE_EDITABLE, obs.OBS_COMBO_FORMAT_STRING)
